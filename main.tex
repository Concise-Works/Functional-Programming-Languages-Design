...
\vfill
\begin{center}
    \Large{Big thanks to \textbf{Professor Nathan Mull}} and\\
    \textbf{TA Jared Pincus}
    \normalsize 
    for teaching CS320: Concepts of Programming Languages\\
    at Boston University \cite{mull_cs320}.\\
    \textit{Content in this document is based on content provided in the course with additional outside-sources.}\\
    \vfill
    \begin{center}
...
\input{Sections/Func/form.tex}

\chapter {Algebraic Data Types}
\input{Sections/adt/adt.tex}

\chapter{Higher-Order Programming}
\input{Sections/order/order}
\input{Sections/error/error}
\input{Sections/mod/mod.tex}

\chapter{The Interpretation Pipeline}
\input{Sections/Formal/gram.tex}
\input{Sections/Parse/parse.tex}
\input{Sections/Eval/eval.tex}
\input{Sections/Fixed/fixed.tex}
\input{Sections/Env/env.tex}
\input{Sections/Types/types.tex}
